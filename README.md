...
If a deterministic rule fits, it's applied and proven. If none fits, the system **escalates to an LLM** for a novel rewrite and its accepted only if the Validator proves it output-identical.
